            ...
            {apps.map((item, index) => {
              ...
              return (
                ...
                >
                  <Tag
                    href={item.href}
                    className="group surface-card block h-full rounded-[1.1rem] px-4 py-4 transition-[transform,border-color] duration-300 hover:-translate-y-1 hover:border-white/[0.16] md:rounded-[1.6rem] md:px-5 md:py-5"
                    {...externalProps}
                  >
